...
<body class="with-welcome-text">
                        ...
                        <?php $no = 1; while ($row = mysqli_fetch_assoc($result)) : ?>
                          <tr>
                            ...
                            <td>
                              ...
                              <button type="button" onclick="hapusPenjualan('<?= $row['id_penjualan']; ?>', '<?= $row['kode_penjualan']; ?>')" class="btn btn-danger btn-sm">
  ...
  <script>
    ...
    function hapusPenjualan(id, kode) {
      if (confirm('Yakin ingin menghapus seluruh transaksi dengan kode ' + kode + '?')) {
        window.location.href = 'index.php?page=controller/PenjualanController&method=DELETE&id=' + id;
      }
    }
  </script>
</body>
